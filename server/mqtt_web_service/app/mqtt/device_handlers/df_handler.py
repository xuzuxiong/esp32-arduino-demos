...
df_handler_bp = Blueprint('df_handler', __name__, url_prefix='/df')
...
@df_handler_bp.route('/device_control/<device_id>', methods=['GET', 'POST'])
def device_control(device_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('df_handler.device_control', device_id=device_id))
...
@df_handler_bp.route('/set_key_setting', methods=['POST'])
def set_key_setting():
