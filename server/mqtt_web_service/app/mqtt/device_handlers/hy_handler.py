...
hy_handler_bp = Blueprint('hy_handler', __name__, url_prefix='/hy')
...
@hy_handler_bp.route('/device_control/<device_id>', methods=['GET', 'POST'])
def device_control(device_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('hy_handler.device_control', device_id=device_id))
...
@hy_handler_bp.route('/set_key_setting', methods=['POST'])
def set_key_setting():
