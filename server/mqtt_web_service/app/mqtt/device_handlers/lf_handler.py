...
lf_handler_bp = Blueprint('lf_handler', __name__, url_prefix='/lf')
...
@lf_handler_bp.route('/device_control/<device_id>', methods=['GET', 'POST'])
def device_control(device_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('lf_handler.device_control', device_id=device_id))
...
@lf_handler_bp.route('/set_key_setting', methods=['POST'])
def set_key_setting():
