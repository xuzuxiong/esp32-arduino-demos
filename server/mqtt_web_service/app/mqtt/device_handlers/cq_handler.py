...
cq_handler_bp = Blueprint('cq_handler', __name__, url_prefix='/de')
...
@cq_handler_bp.route('/device_control/<device_id>', methods=['GET', 'POST'])
def device_control(device_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('cq_handler.device_control', device_id=device_id))
...
@cq_handler_bp.route('/set_key_setting', methods=['POST'])
def set_key_setting():
