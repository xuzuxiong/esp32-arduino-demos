...
de_handler_bp = Blueprint('de_handler', __name__, url_prefix='/de')
...
@de_handler_bp.route('/device_control/<device_id>', methods=['GET', 'POST'])
def device_control(device_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('de_handler.device_control', device_id=device_id))
...
@de_handler_bp.route('/set_key_setting', methods=['POST'])
def set_key_setting():
