...
dd_handler_bp = Blueprint('dd_handler', __name__, url_prefix='/dd')
...
@dd_handler_bp.route('/device_control/<device_id>', methods=['GET', 'POST'])
def device_control(device_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('dd_handler.device_control', device_id=device_id))
...
@dd_handler_bp.route('/set_key_setting', methods=['POST'])
def set_key_setting():
